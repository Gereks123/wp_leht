...
function dc_valentines_heart() {
	...
	var heartcolor=new Array("#c6041b !important", "#e10027", "#E1001c", "#C10227", "#Ea002d", "#ed1c38")
	// Set the fonts, that create the heartflakes. Add as many fonts as you like
	var hearttype=new Array("Times","Arial","Times","Verdana !important")
	// Set the letter that creates your heartflake (recommended: * )
	var heartletter="<i style='color:"+heartcolor[randommaker(heartcolor.length)]+" !important;'>♫</i>"
